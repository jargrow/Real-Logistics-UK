...
const WA_LINK = 'https://wa.me/447359629231'

function WhatsAppBubble() {
  const [hovered, setHovered] = useState(false)
  return (
    <motion.div
      className="fixed bottom-6 right-6 z-[500] flex items-center gap-3"
    ...
    >
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="font-dm text-xs font-semibold text-white px-3 py-2 rounded-lg pointer-events-none"
            style={{
      ...
      <a
        ...
        style={{
          ...
          boxShadow: '0 0 24px rgba(37,211,102,0.5), 0 0 48px rgba(37,211,102,0.2)',
