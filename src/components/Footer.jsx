...
const socials = [
  { name:'Facebook',  href:'https://www.facebook.com/profile.php?id=61590599822254', path:'M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z' },
  { name:'Instagram', href:'https://www.instagram.com/real_logistics.limited/',       path:'M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01M7.5 2h9A5.5 5.5 0 0122 7.5v9A5.5 5.5 0 0116.5 22h-9A5.5 5.5 0 012 16.5v-9A5.5 5.5 0 017.5 2z' },
  { name:'LinkedIn',  href:'#',                                                        path:'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z' },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-4 cursor-pointer">
              <img
                ...
                style={{ filter:'drop-shadow(0 0 8px rgba(26,111,212,0.35))' }}
              />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { icon:'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', text:'+44 1992 661695', href:'tel:+441992661695', label:'Office' },
                { icon:'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', text:'info@real-logistics.co.uk', href:'mailto:info@real-logistics.co.uk', label:'Email' },
                { icon:'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', text:'Nationwide UK Coverage', href:null, label:'Coverage' },
              ].map(item => (
                <li key={item.text} className="flex items-start gap-3">
                  ...
                  {item.href
                    ? <a href={item.href} className="text-[#888] text-sm pt-1.5 hover:text-[#4A90E2] transition-colors">{item.text}</a>
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/447359629231" target="_blank" rel="noopener noreferrer"
                  className="text-sm pt-1.5 font-semibold transition-colors"
                  style={{ color:'#25D366' }}
                  onMouseEnter={e => e.currentTarget.style.color='#4AE68A'}
